 ...
 * Generated for Laravel 5.7.11 on 2018-11-08 16:17:48.
 *
...
namespace App\Support\Tenancy\Facades { 
    ...
    class GetTenancyFacade {
         ...
         * 
         *
         * @param \App\Support\Tenancy\Company $company
         * @param \App\Support\Tenancy\Subsidiary $subsidiary
         * @static 
         */ 
        public static function logMeIn($company, $subsidiary)
        {
            return \App\Support\Tenancy\GetTenancy::logMeIn($company, $subsidiary);
        }
        ...
        {
            return \App\Support\Tenancy\GetTenancy::isRegistered();
        }
        
        /**
         * 
         *
         * @return \App\Support\Tenancy\Company 
         * @static 
         */ 
        public static function getCompany()
        {
            return \App\Support\Tenancy\GetTenancy::getCompany();
        }
        
        /**
         * 
         *
         * @return \App\Support\Tenancy\Subsidiary 
         * @static 
         */ 
        public static function getSubsidiary()
        {
            return \App\Support\Tenancy\GetTenancy::getSubsidiary();
        }
        
        /**
         * 
         *
         * @return \App\Support\Tenancy\Collection 
         * @throws CompanyNotRegisteredException
         * @static 
         */ 
        public static function getCompanySubsidiaries()
        {
            return \App\Support\Tenancy\GetTenancy::getCompanySubsidiaries();
        }
        ...
        {
            return \App\Support\Tenancy\GetTenancy::getAllCompanies();
        }
        ...
        {
            return \App\Support\Tenancy\GetTenancy::getAllSubsidiaries();
        }
    ...
    class GetSubsidiaryParameterFacade {
         ...
         *
         * @param string $name
         * @return bool|\App\Support\Tenancy\Carbon|string|int|float|null 
         * @throws NameSubsidiaryParameterNotFound
         * @static 
         */ 
        public static function getValueByName($name)
        {
            return \App\Support\Tenancy\GetSubsidiaryParameter::getValueByName($name);
        }
...
namespace  { 
    ...
    class Tenant extends \App\Support\Tenancy\Facades\GetTenancyFacade {}

    class Parameter extends \App\Support\Tenancy\Facades\GetSubsidiaryParameterFacade {}
